        ...
        return(
           <div>
                ...
                <div class="splash-container">
                    <div class="splash">
                        <h1 class="splash-head">ChatTime</h1>
                ...
                <div class="content-wrapper">
                    <div class="content">
                        <h2 class="content-head is-center"> Features of ChatTime Application</h2>
                        ...
                        <div class="AppfeaturesFounder">
                            ...
                            <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
                                ...
                                <h2 class="content-head content-head-ribbon">Mark Clarke</h2>

                                <p style={{color:'white'}}>
                                    The Founder of ChatTime. 
                                </p>
                                <p style={{color:'white'}}>
                                Currently working at ChatTime and busy to explore new ideas with new technologies being developed.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="Appfeatures">
                            ...
                            <div class="l-box-lrg pure-u-1 pure-u-md-3-5">
                                <h4>Contact Us</h4>
                                <p>
                                For any question or suggestion you can directly contact me:
                                </p>
                                <p>
                                <a href="https://facebook.com/MClarke9k9/ ">Facebook </a>
                                </p>
                                <p>
                                <a href=" https://www.instagram.com/captianclarke/"> Instagram </a>
                                </p>
